...
namespace ENTITY
{
	...
	static int GET_ENTITY_SPEED(Entity entity) { return invoke<int>(0xD5037BA82E12416F, entity); } // 0xD5037BA82E12416F 0x9E1E4798
...
namespace VEHICLE
{
	...
	static void _SET_VEHICLE_PAINT_FADE(Vehicle vehicle, float fade) { invoke<Void>(0x3AFDC536C3D01674, vehicle, fade); } // 0x3AFDC536C3D01674 0x8332730C
	static float _GET_VEHICLE_PAINT_FADE(Vehicle vehicle) { return invoke<float>(0xA82819CAC9C4C403, vehicle); } // 0xA82819CAC9C4C403 0xD5F1EEE1
...
namespace NETWORKCASH
{
	...
	static int _GET_WALLET_BALANCE(int player) { return invoke<int>(0xA40F9C2623F6A8B5, player); } // 0xA40F9C2623F6A8B5 0x4F5B781C
